...
import com.example.queue_calculator.schemas.validateMM1FiniteProps
...
val inputsDataMM1Finite = listOf(
    mapOf(
...
@Composable
fun MM1_Finite_Screen(navController: NavController) {
    QueueCalculatorTheme {
        Scaffold(
            ...
            MM1_Finite(innerPadding)
        }
    }
}

@Composable
fun MM1_Finite(innerPadding: PaddingValues) {
    ...
    fun submit() {
        ...
        val calculator: ICalculator = MM1Finite()
        ...
        val result = validateMM1FiniteProps(props)
        when (result.isValid) {
            true -> {
    ...
    if (queueResult != null) {
        ...
        Column(modifier = Modifier
            ...
            LazyColumn(
                ...
                items(inputsDataMM1Finite) { data ->
                    InputField(
            ...
            KeyPadGeneral(
                keypadData = when {
                    entries[activeInput].first == "N" -> NoCommaKeyPad
                    else -> CommonKeyPads
                },
...
@Composable
fun MM1_Finite_Preview() {
    MM1_Finite_Screen(rememberNavController())
}